...
{
    [AutoToolCommand(nameof(IfImageExistCommand), typeof(IfImageExistCommand))]
    public class IfImageExistCommand : IfCommand
    {
        ...
        public IfImageExistCommand(IAutoToolCommand? parent = null, IServiceProvider? serviceProvider = null)
