...
namespace AutoTool.Command.Commands
{
    ...
    public class DemoCommand : BaseCommand
    {
        ...
        [SettingProperty("マウス位置設定", SettingControlType.CoordinatePicker,
            ...
            category: "座標")]
        public System.Windows.Point MousePosition { get; set; } = new(0, 0);
        ...
        public System.Windows.Media.Color BackgroundColor { get; set; } = System.Windows.Media.Color.FromRgb(255,255,255);
            ...
            : base(parent, serviceProvider)
        {
            ...
            if (item != null)
            {
                ...
                MousePosition = item.GetSetting("MousePosition", new System.Windows.Point(0, 0));
                ...
                BackgroundColor = item.GetSetting("BackgroundColor", System.Windows.Media.Color.FromRgb(255, 255, 255));
            }
        }
        ...
        protected override void ValidateSettings()
        {
            ...
            if (ExecutionTime < TimeSpan.Zero || ExecutionTime >= TimeSpan.FromSeconds(24 * 60 * 60))
            {
