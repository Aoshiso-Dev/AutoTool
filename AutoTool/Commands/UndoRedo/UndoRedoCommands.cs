...
namespace AutoTool.Commands.UndoRedo
{
    ...
    /// アイテム追加コマンド
    /// </summary>
    public class AddItemCommand : AutoTool.ViewModel.Shared.IUndoRedoCommand
    {
    ...
    /// アイテム削除コマンド
    /// </summary>
    public class RemoveItemCommand : AutoTool.ViewModel.Shared.IUndoRedoCommand
    {
        private readonly UniversalCommandItem _item;
        private readonly int _index;
    ...
    /// アイテム移動コマンド
    /// </summary>
    public class MoveItemCommand : AutoTool.ViewModel.Shared.IUndoRedoCommand
    {
    ...
    /// アイテム編集コマンド
    /// </summary>
    public class EditItemCommand : AutoTool.ViewModel.Shared.IUndoRedoCommand
    {
    ...
    /// 全クリアコマンド
    /// </summary>
    public class ClearAllCommand : AutoTool.ViewModel.Shared.IUndoRedoCommand
    {
